 ...
 * @tree: Pointer to the root node of the tree to calculate its balance factor.
 *
 * Return: Return 0 if the tree is NULL; otherwise, return the balance factor.
 */
 ...
 *
 * Return: If tree is empty, return 0; otherwise, return the height.
 */
